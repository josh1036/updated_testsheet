    ...
    <div className="min-h-screen bg-[#ddd9d4]">
      <div className="bg-white border-b border-stone-200 sticky top-0 z-40">
        <div className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={handleQuickShare} className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-[#0f2044] text-[#0f2044] text-sm hover:bg-blue-50"><Share2 className="w-4 h-4" /> Share PDF</button>
            <button onClick={handlePdf} className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#0f2044] text-white text-sm hover:bg-[#162d4a]"><Download className="w-4 h-4" /> Save PDF</button>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <button onClick={handleQuickShare} className="flex items-center gap-1.5 px-4 py-2 rounded-xl border border-[#0f2044] text-[#0f2044] text-sm hover:bg-blue-50"><Share2 className="w-4 h-4" /> Share PDF</button>
